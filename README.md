...
После одобрения ЮKassa активная форма пожертвования включается только через runtime secrets. Ключи YooKassa не хранятся в репозитории. Форма временно отключена до завершения настройки приема пожертвований без кассовых чеков на товары, работы или услуги.
