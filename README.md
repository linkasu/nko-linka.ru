...
Ежемесячные пожертвования подготовлены в коде, но включаются только после подключения автоплатежей YooKassa для магазина и установки runtime `YOOKASSA_RECURRING_ENABLED=true`.
