...
- После одобрения ЮKassa форма пожертвования включается через runtime secrets без хранения платежных ключей в репозитории; 2026-07-09 форма временно отключена до настройки приема пожертвований без кассовых чеков на товары, работы или услуги.
